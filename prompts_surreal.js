...
const generateSurrealBatch = (count = 20) => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    batch.push(`videos[${i}] = \`photorealistic hyper realistic video of - SUBJECT: ${subjects} - TRANSFORMATION: ${trans} - ENVIRONMENT: ${env} - TONE: ${tone} - MODIFIERS: ${mods} - ENHANCERS: ${enh}\`;`);
