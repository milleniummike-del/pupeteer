...
const fs = require('fs');
const userDataDir = process.argv[2]||"browser";
...
async function uploadToTikTok(page, videoPath, caption = "") {
...
async function main(){
const page = await loadBrowser("https://www.tiktok.com/upload?lang=en");
// Run it
uploadToTikTok(
    page,
